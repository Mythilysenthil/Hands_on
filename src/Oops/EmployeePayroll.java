...
public class EmployeePayroll { 
	public static void main(String[] args) { 
		Employee e1 = new PermanentEmployee("P101", "Mythily", 50000.0, 10000.0); 
		Employee e2 = new ContractEmployee("C202", "shob", 40000.0, 0.10, 2000.0); 
		Employee e3 = new Intern("I303", "gayuu", 15000.0); 
