...
public class PaymentSystem {
	...
	public static void main(String[] args) {
		...
		Payment p1 = new CreditCardPayment("TXN101", 2500.0, "Mythily", "1234567812345678", "123", "12/27"); 
		Payment p2 = new UPIPayment("TXN202", 1500.0, "Shob", "shob@bank", "4321"); 
		Payment p3 = new NetBankingPayment("TXN303", 5000.0, "Gayuu", "HDFC", "12345678", "HDFC0001234"); 
